const dfeQualifiedTeacherStatus = {
    ...
    translations: {
        en: {
            ...
            linkUrl: "https://apply-for-qts-in-england.education.gov.uk/teacher/application",
        },
        cy: {
            header: "Gwneud cais am statws athro cymwysedig (SAC)",
            description: "Gall athrawon cymwys a hyfforddwyd y tu allan i Loegr wneud cais am SAC.",
            linkText: "Ewch i'r gwasanaeth gwneud cais am statws athro cymwysedig (SAC)",
            linkUrl: "https://apply-for-qts-in-england.education.gov.uk/teacher/application",
        },
    },
};
