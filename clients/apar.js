const apar = {
    ...
    translations: {
        en: {
            ...
            linkText: "Go to your apprenticeship provider and assessment register account",
            linkUrl: "https://apply.apprenticeships.education.gov.uk/signIn",
        },
        cy: {
            header: "Cofrestr darparwr prentisiaeth ac asesiad",
            description: "Dechrau neu barhau â chais i ymuno â'r darparwr prentisiaeth a'r gofrestr asesiadau.",
