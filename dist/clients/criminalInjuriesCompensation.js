...
const criminalInjuriesCompensation = {
    clientId: {
    ...
    translations: {
        en: {
            ...
            linkUrl: "https://claim-criminal-injuries-compensation.service.justice.gov.uk/account",
        },
        cy: {
            header: "Digolledau anafiadau troseddol",
            description: "Dechrau neu barhau â chais i gael eich digolledu am anafiadau neu golledion os ydych wedi bod yn ddioddefwr o drosedd treisiol.",
            linkText: "Ewch i’ch cyfrif digolledion anafiadau troseddol",
            linkUrl: "https://claim-criminal-injuries-compensation.service.justice.gov.uk/account",
        },
    },
};
exports.default = criminalInjuriesCompensation;
